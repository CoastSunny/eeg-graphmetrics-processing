...
if isempty(betaLim);        betaLim     = Inf;  end
if isempty(gammaLim);       gammaLim    = Inf;  end
if isempty(varLim);         varLim      = Inf;  end
if isempty(invVarLim);      invVarLim   = Inf;  end
if isempty(kurtLim);        kurtLim     = Inf;  end
if isempty(zScoreLim);      zScoreLim   = Inf;  end
if isempty(vMaxLim);        vMaxLim     = Inf;  end
